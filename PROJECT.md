...
| Vocos | In progress | | | Being extracted from f5_tts into its own model folder, covering both the mel and EnCodec frontends, and wired into f5_tts and vox_instruct. |
