...
# (i.e. while `.modeling_spark_tts_bicodec` below is being imported), neither of which knows about
# voicestudio-only models; must run before that import or its "Config not found" fallback warning
# already fired.
HARDCODED_CONFIG_FOR_MODELS["spark-tts-bicodec"] = "SparkTTSBiCodecConfig"

from .configuration_spark_tts_bicodec import SparkTTSBiCodecConfig
from .modeling_spark_tts_bicodec import SparkTTSBiCodecModel, SparkTTSBiCodecPreTrainedModel
